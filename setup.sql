...
GRANT USAGE ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE TABLE ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE STAGE ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
...
-- Create Datasets
GRANT CREATE FILE FORMAT ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE DATASET ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;

-- Create and execute tasks
GRANT CREATE TASK ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT EXECUTE TASK ON ACCOUNT TO ROLE EVAL_ROLE;

-- Run evaluations
GRANT MONITOR ON FUTURE AGENTS IN SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
...
GRANT CREATE GIT REPOSITORY ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;

-- Service and Agent creation
GRANT CREATE SEMANTIC VIEW ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE CORTEX SEARCH SERVICE ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE PROCEDURE ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
GRANT CREATE AGENT ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE EVAL_ROLE;
...
GRANT MONITOR ON FUTURE AGENTS IN SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE ACCOUNTADMIN;
GRANT CREATE DATASET ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE ACCOUNTADMIN;

-- Create and execute tasks
GRANT CREATE TASK ON SCHEMA CUST_SUPPORT_DEMO.SUPPORT TO ROLE ACCOUNTADMIN;

SELECT * FROM CUST_SUPPORT_DEMO.SUPPORT.EVAL_DATA;

-- First we will create a dataset to use for evaluating our agent
CALL SYSTEM$CREATE_EVALUATION_DATASET(
    'Cortex Agent',
    'CUST_SUPPORT_DEMO.SUPPORT.EVAL_DATA',
    'CUST_SUPPORT_DEMO.SUPPORT.SUPPORT_AGENT_EVAL_DATASET',
...
COPY FILES INTO @CUST_SUPPORT_DEMO.SUPPORT.EVAL_CONFIG_STAGE
